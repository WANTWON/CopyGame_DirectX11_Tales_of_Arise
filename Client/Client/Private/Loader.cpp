...
#include "UI_Damagefont_BoostBreak.h"
...
HRESULT CLoader::Loading_ForPrototype()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_UI_damagefontboostbreak"),
		UI_Damagefont_BoostBreak::Create(m_pDevice, m_pContext))))
		return E_FAIL;
...
#pragma region Deco CityMap Object
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Stair02"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../../../Bin/Bin_Data/NonAnim/Saternas/Stair02.dat"))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Stair03"),
...
#pragma region Instancing City
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("CIty_Rock1"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM_INSTANCE, "../../../Bin/Bin_Data/NonAnim/Astrik/Rock1.dat",
			"../../../Bin/Data/City_Data/Rock1.dat"))))
		return E_FAIL;
...
#pragma region Instancing SnowField
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("CliffRock1_SnowField"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM_INSTANCE, "../../../Bin/Bin_Data/NonAnim/CliffRock/CliffRock.dat",
			"../../../Bin/Data/Field_Data/CliffRock_1.dat"))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("CliffRock2_SnowField"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM_INSTANCE, "../../../Bin/Bin_Data/NonAnim/CliffRock/CliffRock2.dat",
			"../../../Bin/Data/Field_Data/CliffRock_2.dat"))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("CliffRock3_SnowField"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM_INSTANCE, "../../../Bin/Bin_Data/NonAnim/CliffRock/CliffRock3.dat",
			"../../../Bin/Data/Field_Data/CliffRock_3.dat"))))
		return E_FAIL;

	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("CliffRock4_SnowField"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM_INSTANCE, "../../../Bin/Bin_Data/NonAnim/CliffRock/CliffRock4.dat",
			"../../../Bin/Data/Field_Data/CliffRock_4.dat"))))
		return E_FAIL;
...
HRESULT CLoader::Loading_ForUITexture()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_charactername"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../../Bin/Resources/Textures/UI/charactername/charactername%d.dds"), 6))))
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_QUESTNAME"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../../Bin/Resources/Textures/UI/quest/questname%d.dds"), 5))))
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_Skillname"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../../Bin/Resources/Textures/UI/skillmsg/skillname%d.dds"), 32))))
		return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Prototype_Component_Texture_SpecialDamagefont"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../../Bin/Resources/Textures/UI/specialdamage/specialdamage%d.dds"), 5))))
		return E_FAIL;
...
HRESULT CLoader::Loading_ForEffect()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("Cone01"),
...
HRESULT CLoader::Loading_ForEffectTexture()
{
	...
	if (FAILED(pGameInstance->Add_Prototype(LEVEL_STATIC, TEXT("ShieldTexture"),
		CTexture::Create(m_pDevice, m_pContext, TEXT("../../../Bin/Resources/Textures/Effect/Unique/ShieldTexture.png"), 1))))
		return E_FAIL;
