...
CUI_Portraitfront_sub2::CUI_Portraitfront_sub2(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI_Portraitfront(pDevice, pContext)
{
}

CUI_Portraitfront_sub2::CUI_Portraitfront_sub2(const CUI_Portraitfront_sub2 & rhs)
	: CUI_Portraitfront(rhs)
{
}

HRESULT CUI_Portraitfront_sub2::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CUI_Portraitfront_sub2::Initialize(void * pArg)
{
...
int CUI_Portraitfront_sub2::Tick(_float fTimeDelta)
{
	...
	m_fCurrentBoost = CPlayerManager::Get_Instance()->Get_EnumPlayer(5)->Get_Info().fCurrentBoostGuage;
...
void CUI_Portraitfront_sub2::Late_Tick(_float fTimeDelta)
{
	if (CUI_Manager::Get_Instance()->Get_Mainmenuon())
		return;
	if (CUI_Manager::Get_Instance()->Get_StopTick() || CBattleManager::Get_Instance()->Get_IsStrike())
...
HRESULT CUI_Portraitfront_sub2::Render()
{
...
HRESULT CUI_Portraitfront_sub2::Render_Glow()
{
...
HRESULT CUI_Portraitfront_sub2::Ready_Components(void * pArg)
{
	/* For.Com_Renderer */
...
HRESULT CUI_Portraitfront_sub2::SetUp_ShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
CUI_Portraitfront_sub2 * CUI_Portraitfront_sub2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CUI_Portraitfront_sub2*	pInstance = new CUI_Portraitfront_sub2(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		ERR_MSG(TEXT("Failed to Created : CUI_Portraitfront_sub2"));
...
CGameObject * CUI_Portraitfront_sub2::Clone(void * pArg)
{
	CUI_Portraitfront_sub2*	pInstance = new CUI_Portraitfront_sub2(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		ERR_MSG(TEXT("Failed to Cloned : CUI_Portraitfront_sub2"));
		Safe_Release(pInstance);
	}
...
void CUI_Portraitfront_sub2::Free()
{
