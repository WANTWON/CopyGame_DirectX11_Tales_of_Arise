...
CItemmsgbox::CItemmsgbox(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	: CUI_Base(pDevice, pContext)
{
}

CItemmsgbox::CItemmsgbox(const CItemmsgbox & rhs)
	: CUI_Base(rhs)
{
}

HRESULT CItemmsgbox::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CItemmsgbox::Initialize(void * pArg)
{
...
int CItemmsgbox::Tick(_float fTimeDelta)
{
	//	if (m_btick)
	//	{
...
void CItemmsgbox::Late_Tick(_float fTimeDelta)
{
...
HRESULT CItemmsgbox::Ready_Components(void * pArg)
{
	/* For.Com_Renderer */
...
HRESULT CItemmsgbox::SetUp_ShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
...
CItemmsgbox * CItemmsgbox::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CItemmsgbox*	pInstance = new CItemmsgbox(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		ERR_MSG(TEXT("Failed to Created : CItemmsgbox"));
...
CGameObject * CItemmsgbox::Clone(void * pArg)
{
	CItemmsgbox*	pInstance = new CItemmsgbox(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		ERR_MSG(TEXT("Failed to Cloned : CItemmsgbox"));
		Safe_Release(pInstance);
	}
