			...
			if (ANIMEVENT::EVENTTYPE::EVENT_EFFECT == pEvent.eType)
			{
				...
				switch (m_iCurrentAnimIndex)
				{
					case CAlphen::ANIM::ANIM_ATTACK_NORMAL_0:
						if (!m_bAttackSound1)
						{
							CGameInstance::Get_Instance()->PlaySounds(TEXT("Player_Normal_Attack1.wav"), SOUND_ALPHEN_NORMAL_ATTACK, 0.25f);
					...
					case CAlphen::ANIM::ANIM_ATTACK_NORMAL_8:
						...
						if (!m_bAttackSound2)
						{
							CGameInstance::Get_Instance()->PlaySounds(TEXT("Player_Normal_Attack2.wav"), SOUND_ALPHEN_NORMAL_ATTACK, 0.25f);
					...
					case CAlphen::ANIM::ANIM_ATTACK_NORMAL_1:
						...
						if (!m_bAttackSound3)
						{
							CGameInstance::Get_Instance()->PlaySounds(TEXT("Player_Normal_Attack3.wav"), SOUND_ALPHEN_NORMAL_ATTACK, 0.25f);
					...
					case CAlphen::ANIM::ANIM_ATTACK_NORMAL_6:
						...
						if (!m_bAttackSound4)
						{
							CGameInstance::Get_Instance()->PlaySounds(TEXT("Player_Normal_Attack4.wav"), SOUND_ALPHEN_NORMAL_ATTACK, 0.25f);
