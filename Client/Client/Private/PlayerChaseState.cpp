#include "stdafx.h"
#include "..\Public\PlayerChaseState.h"
...
CPlayerChaseState::CPlayerChaseState(CPlayer * pPlayer, STATE_ID eStateType)
{
	m_eStateId = eStateType;
	m_pOwner = pPlayer;
}

CPlayerState * CPlayerChaseState::HandleInput()
{
...
CPlayerState * CPlayerChaseState::Tick(_float fTimeDelta)
{
...
CPlayerState * CPlayerChaseState::LateTick(_float fTimeDelta)
{
...
CPlayerState * CPlayerChaseState::EventInput(void)
{
	return nullptr;
}

void CPlayerChaseState::Enter()
{
	__super::Enter();
