...
void CLevel_SnowField::Tick(_float fTimeDelta)
{
	...
	{
		CBattleManager::Get_Instance()->Set_BattleMode(true, RINWELL);
	}
...
//			return E_FAIL;
	...
	if (FAILED(pGameInstance->Add_GameObject(TEXT("Prototype_GameObject_UI_ScreenFadeEffect"), LEVEL_STATIC, pLayerTag)))
		return E_FAIL;
