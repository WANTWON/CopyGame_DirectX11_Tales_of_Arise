#include "stdafx.h"
#include "..\Public\Monster_Law_StrikeTrigger2.h"
#include "Law.h"
...
CMonster_Law_StrikeTrigger2::CMonster_Law_StrikeTrigger2(CMonsterLaw * pPlayer)
{
	//m_bbackstep = back;
	m_pOwner = pPlayer;
...
CMonsterLawState * CMonster_Law_StrikeTrigger2::Tick(_float fTimeDelta)
{
...
CMonsterLawState * CMonster_Law_StrikeTrigger2::LateTick(_float ftimeDelta)
{
	...
	for (auto& pEvent : pEvents)
	{
		if (pEvent.isPlay)
		{
			if (ANIMEVENT::EVENTTYPE::EVENT_COLLIDER == pEvent.eType)
			{
				...
				return new CMonsterLaw_Strike2(m_pOwner, m_pTarget);
...
void CMonster_Law_StrikeTrigger2::Enter()
{
...
void CMonster_Law_StrikeTrigger2::Exit(void)
{
	//__super::Exit();
...
void CMonster_Law_StrikeTrigger2::Update_StrikePosition(_tchar * FilePath, _int iMonsterPosNum)
{
