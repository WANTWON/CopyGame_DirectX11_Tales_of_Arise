...
void CPlayer_RinwellNormalAttack_State::Enter()
{
	...
	if (m_bIsFly)
	{
		...
		case Client::CPlayerState::STATE_NORMAL_ATTACK1:
			...
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack1.wav"), SOUND_RINWELL_NORMAL_ATTCK, 1.0f);
			break;
		case Client::CPlayerState::STATE_NORMAL_ATTACK2:
			pCamera->Set_Zoom(true, -6.f, 0.5f, 5.f, 8.f);

			m_pOwner->Get_Model()->Set_CurrentAnimIndex(CRinwell::ANIM::BTL_ATTACK_NORMAL_AIR_1);
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack2.wav"), SOUND_RINWELL_NORMAL_ATTCK, 1.0f);
			break;
		case Client::CPlayerState::STATE_NORMAL_ATTACK3:
			pCamera->Set_Zoom(true, -6.f, 0.5f, 5.f, 8.f);

			m_pOwner->Get_Model()->Set_CurrentAnimIndex(CRinwell::ANIM::BTL_ATTACK_NORMAL_AIR_2);
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack3.wav"), SOUND_RINWELL_NORMAL_ATTCK, 1.0f);
			break;
	...
	else
	{
		...
		case Client::CPlayerState::STATE_NORMAL_ATTACK3:
			...
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack.wav"), SOUND_RINWELL_NORMAL_ATTCK, 0.6f);
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack_Voice3.wav"), SOUND_RINWELL_VOICE, 0.6f);
			break;
		case Client::CPlayerState::STATE_NORMAL_ATTACK4:
			pCamera->Set_Zoom(true, -6.f, 0.5f, 5.f, 8.f);
			...
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack.wav"), SOUND_RINWELL_NORMAL_ATTCK, 0.6f);
			CGameInstance::Get_Instance()->PlaySounds(TEXT("Rinwell_Normal_Attack_Voice4.wav"), SOUND_RINWELL_VOICE, 0.6f);
			break;
		}
	}
