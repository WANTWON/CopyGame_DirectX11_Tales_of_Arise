...
namespace Client
{
	...
	enum LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_SNOWFIELD, LEVEL_BATTLE, LEVEL_CITY, LEVEL_RESTAURANT, LEVEL_WORKTOOL, LEVEL_LAWARENA,  LEVEL_BOSS, LEVEL_END };
