...
namespace Client
{
	...
	enum SHADER_ANIMID { SHADER_ANIMDEFAULT, SHADER_ANIMSHADOW, SHADER_ANIM_DISSOLVE, SHADER_ANIM_GLOW };
	...
	enum SHADER_EFFECT { SHADER_DEFAULT, SHADER_EFFECT, SHADER_DISTORTION, SHADER_GLOW, SHADER_END };
