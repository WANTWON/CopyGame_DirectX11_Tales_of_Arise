...
namespace Client
{
	...
	enum SOUND_ID { SOUND_BGM, SOUND_SYSTEM, SOUND_VOICE, SOUND_FOOT, SOUND_WEAPON, SOUND_EFFECT, SOUND_SKILL, SOUND_OBJECT, SOUND_NATURE,SOUND_CROWD, SOUND_UI, SOUND_HIT, SOUND_SMASH,
