...
namespace Client
{
	...
	/* Shader Enums */
	enum SHADER_ANIMID { SHADER_ANIMDEFAULT, SHADER_ANIMSHADOW, SHADER_ANIM_DISSLOVE, SHADER_ANIM_GLOW };
	enum SHADER_NONANIMID { SHADER_NONANIMDEFAULT, SHADER_NONANIM_SHADOW, SHADER_NONANIM_WATER, SHADER_NONANIM_DISSOLVE, SHADER_NONANIM_GLOW };
	enum SHADER_EFFECT { SHADER_DEFAULT, SHADER_ALPHAMASK, SHADER_DISTORTION, SHADER_GLOW, SHADER_END };
