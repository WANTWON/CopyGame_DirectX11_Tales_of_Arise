...
namespace Client
{
	...
	enum SOUND_ID { SOUND_BGM, SOUND_SYSTEM, SOUND_VOICE, SOUND_VOICE_SECOND, SOUND_VOICE_THIRD, SOUND_VOICE_FOURTH, SOUND_VOICE_FIFTH, SOUND_FOOT, SOUND_WEAPON, SOUND_EFFECT, SOUND_OBJECT, SOUND_END };
