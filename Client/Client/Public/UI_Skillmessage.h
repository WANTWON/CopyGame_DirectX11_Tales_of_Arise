...
public:
	...
	enum SKILLNAME {
		...
		SKILLNAME_RAINOUI,
		SKILLNAME_ALPHENLAWSTRIKE,
		SKILLNAME_RINWELLLAWSTRIKE,
		SKILLNAME_SIONLAWSTRIKE,
		SKILLNAME_ALPHENSIONSTRIKE,
		SKILLNAME_ALPHENRINWELLSTRIKE,
		SKILLNAME_SIONRINWELLSTRIKE
