...
public:
	enum COLLSIONGROUP { COLLISION_PLAYER, COLLISION_MONSTER, COLLISION_PBULLET, COLLISION_MBULLET, COLLISION_INTERACT,COLLISION_TRIGGER, COLLISION_MINIGAME1, COLLISION_END };
