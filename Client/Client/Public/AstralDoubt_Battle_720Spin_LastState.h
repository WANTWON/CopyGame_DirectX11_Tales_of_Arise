...
BEGIN(Client)
BEGIN(Astral_Doubt)
class CBattle_720Spin_LastState : public CAstralDoubt_State
{
public:
	CBattle_720Spin_LastState(class CAstralDoubt* pAstral_Doubt, FIELD_STATE_ID ePreState = FIELD_STATE_ID::FIELD_STATE_IDLE);
