...
public:
	enum SHADERUI_ID {
		UI_ALPHADEFAULT, UI_ALPHABLEND, UI_PICKED, UI_ALPHASET, UI_SCREEN, UI_EFFECTFADEOUT, UI_HPBAR, UI_COMBOLINE, UI_GOLDEN, UI_CP_GUAGE,
		...
		UI_BOSSHPFULL, UI_BOSSHPBACKBLACK, UI_BOSSHPBACKWHITE, UI_EFFECTSCREEN, UI_GLOW, UI_EXPBAR, UI_STRIKEEFFECT, UI_SPRITE_GLOW,
		UI_RECOVERFONT,UI_PlayerHitfont,UI_JUSTDODGE,UI_RESISTDAMAGEFONT,UI_CRITICALDAMAGEFONT, UI_ALPHADISCARD, UI_CURSOR , UI_CURSORNOTMOVE,
		UI_REALEXP,
		UI_END };
