...
class CUI_SidePopup final : public CUI_Base
{
private:
	CUI_SidePopup(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_SidePopup(const CUI_SidePopup& rhs);
	virtual ~CUI_SidePopup() = default;
...
public:
	static CUI_SidePopup* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
private:
	...
	_float m_fnameAlpha = -3.f;
	_bool m_bfadeinname = false;
