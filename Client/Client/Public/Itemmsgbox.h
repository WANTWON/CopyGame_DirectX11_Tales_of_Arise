...
class CItemmsgbox final : public CUI_Base
{
private:
	CItemmsgbox(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CItemmsgbox(const CItemmsgbox& rhs);
	virtual ~CItemmsgbox() = default;
...
public:
	static CItemmsgbox* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
