...
public:
	enum ANIM {
		...
		ANIM_RUN_BRAKE_END, ANIM_RUN_BRAKE_START, ANIM_USE_ITEM, ANIM_WALK, ANIM_WALK_TO_IDLE_SIDE_END, ANIM_WALK_TO_IDLE_SIDE_START, ANIM_ATTACK_SHUNRAI, ANIM_DODGE_AIR, ANIM_DODGE_BACK, ANIM_DODGE_FRONT, ANIM_END
	};
