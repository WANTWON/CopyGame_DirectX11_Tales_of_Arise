...
namespace Client
{
	...
	enum MODEL { MODEL_ALPHEN, MODEL_ICEWOLF, MODEL_SION, MODEL_BERSERKER, MODEL_HAWK, MODEL_ASTRAL_DOUBT, MODEL_RINWELL, MODEL_LAW, MODEL_ASU_005, MODEL_ORIGIN_ASU, MODEL_CURRENT_ASU, MODEL_END };
