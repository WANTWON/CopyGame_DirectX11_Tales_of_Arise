...
namespace Client
{
	...
	enum MODEL { MODEL_ALPHEN, MODEL_ICEWOLF, MODEL_SION, MODEL_BERSERKER, MODEL_HAWK, MODEL_ASTRAL_DOUBT, MODEL_RINWELL, MODEL_LAW, MODEL_NPC_PLC, MODEL_NPC_GLD, MODEL_NPC_MHB, MODEL_NPC_DIM, MODEL_NPC_FIA, MODEL_NPC_GNL, MODEL_NPC_WAC, MODEL_DOG, MODEL_DUCK,MODEL_END };
