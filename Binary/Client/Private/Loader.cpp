...
HRESULT CLoader::Loading_ForGamePlayLevel(void)
{
	...
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/TreasureBox02_Blue.fbx", "../../../Bin/Bin_Data/Anim/SYS_TreasureBox02_Blue/", PivotMatrix))))
	//	return E_FAIL;

	//if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("TreasureBox02_Red"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/TreasureBox02_Red.fbx", "../../../Bin/Bin_Data/Anim/SYS_TreasureBox02_Red/", PivotMatrix))))
	//	return E_FAIL;

	//if (FAILED(pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("TreasureBox00"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Meshes/TreasureBox00.fbx", "../../../Bin/Bin_Data/Anim/SYS_TreasureBox00/", PivotMatrix))))
	//	return E_FAIL;
