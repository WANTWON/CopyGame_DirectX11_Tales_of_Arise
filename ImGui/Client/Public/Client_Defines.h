...
namespace Client
{
	...
	enum MODEL { MODEL_ALPHEN, MODEL_SION, /*MODEL_RINWELL, */MODEL_LAW, MODEL_ICEWOLF, MODEL_BERSERKER, MODEL_HAWK, MODEL_ASTRAL_DOUBT, MODEL_TREASURE, MODEL_KISARA, MODEL_DUOHALEM, MODEL_END };
